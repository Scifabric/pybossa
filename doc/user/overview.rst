...
3. After clicking in the previous button, you will have to fill in a form
   with the following information:
     ...
     3. **Description**: A **short** description of the project, i.e.
     ...
     5. **Allow Anonymous Contributors**: By default anonymous and
        ...
        participate. 
     6. **Category**: Select a category that fits your project.
        :ref:`categories` 
     ...
     7. **Long Description**: A *long* description where you can use Markdown
        ...
        project, etc.
     8. **Hide**: Click in this field if you want to hide the project.
...
your account in the *Published* projects section:
