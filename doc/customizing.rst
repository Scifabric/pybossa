...
work, the API will hide all that information except for the owner. This will make impossible
to show users's badges to anonymous people, which is not desired.

With Projects could be the same. You want to hightlight some info to anyone, but hide everything else.
...
.. note::
    ...
    WARNING: be very careful. This is your responsability, and it's not enabled by default. If you
    expose your own private data via this field, it's your own responsability as this is not enabled
