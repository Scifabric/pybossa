...
class BulkTaskSPARQLImport(BulkTaskImport):
    ...
    def __init__(self, sparql_url, last_import_meta=None):
        self.url = sparql_url
    ...
    def tasks(self):
        ...
        return self._get_sparql_data_from_request(r)

    def _get_data_url(self):
        """Get data from URL."""
        return self.url

    def _import_sparql_tasks(self, sparqlreader):
        """Import sparql tasks."""
        headers = []
    ...
    def _get_sparql_data_from_request(self, r):
        """Get sparql data from a request."""
        ...
        r.encoding = 'utf-8'
        sparqlcontent = StringIO(r.text)
        sparqlreader = unicode_csv_reader(sparqlcontent)
        return self._import_sparql_tasks(sparqlreader)
